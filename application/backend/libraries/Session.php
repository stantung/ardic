...
class CI_Session {
	...
	{
		//	echo $this->sess_use_database.br(1);
		//	echo $this->userdata['session_id'].br(1);
		
		// print_r($this->userdata['cart_contents']));
		...
		// $t = array('content' => $this->_get_time());
		// $this->CI->db->insert('t1', $t);
		
		log_message('debug', 'session destroy');
